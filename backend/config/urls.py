...
schema_view = get_schema_view(
    openapi.Info(
        title="RESTester TaaS API",
        default_version="v1",
        description="Testing as a Service (TaaS) Implementation based on RESTester testing backend",
        terms_of_service="https://www.google.com/policies/terms/",
        contact=openapi.Contact(email="info@restester.com"),
